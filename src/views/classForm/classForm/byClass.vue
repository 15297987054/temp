    ...
    <a-row :gutter="20">
      ...
      <a-col :span="5">
        <div class="choose_date_box">
          ...
          <a-date-picker :value="moment(dateValue,'YYYY-MM-DD dddd')" :v-model="moment(dateValue,'YYYY-MM-DD dddd')" @change="onChange" />
...
import {getClassListByClass} from '@/api/class'
...
export default {
 ...
 created: function() {
  ...
  methods: {
    classListByClass() {
      getClassListByClass({ pageNum: 1, pageSize: 10, beginDate: this.lastMonday, endDate: this.lastSunday,nameOrNo:this.nameOrNo}).then(res => {
        var arr = res.rows
        var arrt = []
    ...
    onSearch(value) {this.nameOrNo=value;this.classListByClass(),this.nameOrNoValue=''}
  }
}
</script>
